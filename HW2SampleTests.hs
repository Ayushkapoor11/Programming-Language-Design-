...
p2a_test1 = TestCase (assertEqual "removDuplicates [5,4,3,2,1,1,2,3,4,5,6,7]" (sort [1,2,3,4,5,6,7])  (sort (removDuplicates [5,4,3,2,1,1,2,3,4,5,6,7])) )
p2a_test2 = TestCase (assertEqual "removDuplicates \"CptS322 - CptS322 -  CptS 321\""  (sort "-CptS 321") (sort (removDuplicates "CptS322 - CptS322 -  CptS 321")) )
p2a_test3 = TestCase (assertEqual "removDuplicates [[1,2],[1],[],[3],[1],[]]" (sort [[1,2],[3],[1],[]])  (sort (removDuplicates [[1,2],[1],[],[3],[1],[]])) )
...
p3a_test3 = TestCase (assertEqual "test 3a-3" "Work to be completed now" (concatAll [["Work"," ","to"," "],["be"," ","completed"],[" ","now"]]) )
p3a_test4 = TestCase (assertEqual "test 3a-4" "24 will not be time" (concatAll [["24"," ","will"," "],["not"," ","be"],[" ","time"]]) )
...
p3b_test4 = TestCase (assertEqual "test 3b-4" (AString "28" ) (concat2Either [[AString "", AnInt 28],[]]) )
p3b_test5 = TestCase (assertEqual "test 3b-5" (AString "" ) (concat2Either []) )
...
p3c_test4 = TestCase (assertEqual "test 3c-4" ("28") (concat2Str [[AString "", AnInt 28],[]]) )
p3c_test5 = TestCase (assertEqual "test 3c-5" ("3000") (concat2Str [[AString "", AnInt 3000],[]]) )
...
p4a_test4 = TestCase (assertEqual "evaluateTree exprtree3" 63 (evaluateTree exprtree3) )
p4a_test5 = TestCase (assertEqual "evaluateTree exprtree4" 46 (evaluateTree exprtree4) )
...
p4b_test4 = TestCase (assertEqual "printInfix exprtree3" "(((1 `Add` 2) `Add` 6) `Mul` (4 `Add` 3))" (printInfix  exprtree3) )
p4b_test5 = TestCase (assertEqual "printInfix exprtree4" "(((3 `Add` 4) `Mul` 6) `Add` (10 `Sub` 6))" (printInfix  exprtree4) )
